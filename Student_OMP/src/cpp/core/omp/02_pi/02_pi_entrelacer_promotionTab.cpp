...
double piOMPEntrelacerPromotionTab(int n)
    ...
    double sum=0;
    double* tabSumThread = new double[NBTHREAD];//Ne pas oublier initialiser les éléments à 0
	...
	double xs;
        ...
        //Initialiser le tableau à 0 de manière parallèle
        tabSumThread[TID]=0;
        while(s<n){
            xs = s*DX;
