...
MandelbrotJuliaMGPU* MandelbrotJuliaProviderMGPU::create()
    {
	...
	x2 = -1.3578;
	y2 = 0.0013973;
	return new MandelbrotJuliaMGPU(dw, dh, dt, n, isJulia,c1,c2,x1,y1,x2,y2);
	}
    else
	{
	x1 = -1.3;
...
ImageFonctionel* MandelbrotJuliaProviderMGPU::createGL(void)
    {
