...
FractalMulti* FractalProviderMulti::create()
    {
    ...
    return new FractalMulti(dw, dh, dt, nMin,nMax,julia,cx,cy,xMin,xMax,yMin,yMax);
    }

ImageFonctionel* FractalProviderMulti::createGL(void)
    {
