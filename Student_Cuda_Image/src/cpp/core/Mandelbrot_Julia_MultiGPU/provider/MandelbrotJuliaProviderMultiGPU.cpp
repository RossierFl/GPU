...
MandelbrotJuliaMultiGPU* MandelbrotJuliaProviderMultiGPU::create()
    {
  ...
  /*  bool isJulia=false;
   ...
   bool isJulia = false;
    ...
    return new MandelbrotJuliaMultiGPU(dw, dh, dt, n,xMin,xMax,yMin,yMax,isJulia,cX,cY);
    }

ImageFonctionel* MandelbrotJuliaProviderMultiGPU::createGL(void)
    {
